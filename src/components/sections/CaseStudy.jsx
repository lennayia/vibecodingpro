...
<motion.div
  ...
  className="max-w-2xl mx-auto mb-6 mt-8 text-center"
>
  <div className="font-light leading-relaxed italic mb-0 text-xl">
      ...
      <span className="text-5xl text-accent/30 font-serif leading-none ml-1 inline-block" style={{ verticalAlign: 'middle' }}>"</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {benefits.map((benefit, index) => (
              ...
              >
                <Card background="dark" className="h-full" animate={false}>
                  <div className="text-center">
                    <AnimatedStatValue
                      value={benefit.value}
                      delay={0.8 + index * 0.1}
                      className="font-display font-bold text-3xl md:text-4xl text-accent block mb-2"
                    />
